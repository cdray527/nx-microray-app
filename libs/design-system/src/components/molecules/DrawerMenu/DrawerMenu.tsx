...
export const DrawerMenu: React.FC<DrawerMenuProps> = ({ id, direction }) => {
    return (
        <div
            id={id}
                    ...
                    <li>
                        ...
                        >
                            <svg
                                ...
                                viewBox="0 0 18 20"
                            >
                                <path d="M15 0H3a3 3 0 0 0-3 3v14a3 3 0 0 0 3 3h12a3 3 0 0 0 3-3V3a3 3 0 0 0-3-3Zm-5 16H8v-2h2v2Zm0-4H8V4h2v8Z" />
                            </svg>
